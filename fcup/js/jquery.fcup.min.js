/* * 文件分段上传jquery插件 * author:lovefc * time:2018/01/05 23:05 * uptime:2018/01/17 23:05 */
(function(jQuery) {
...
var big_upload = {
    fcup: function(config) {
        ...
        if (jQuery.updom && jQuery.upurl) {
            jQuery.fcup_add(fromData);
        }
      //  console.log(fromData);
    },
    fcup_add: function(fromData = 0) {
        var html = '<div class="fcup-button">';
        html += jQuery.upstr;
        html += '<input type="file" id="' + jQuery.upid + '" onchange="jQuery.big_upload('+fromData+')" style="position:absolute;font-size:100px;right:0;top:0;opacity:0;">';
        html += '</div>';
      //  console.log(html);
